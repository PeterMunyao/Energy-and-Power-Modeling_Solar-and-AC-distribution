...
# Load your file
df = pd.read_csv("csv_40.886273_23.912687_fixed_23_180_PT5M.csv")

# Adjusting for 0-indexing (rows 74 to 180 inclusive)
# This selects rows 74 to 180 from the spreadsheet view
extracted_data = df.iloc[73:180][["air_temp", "wind_speed_10m", "ghi", "relative_humidity", "cloud_opacity"]]

# Print as a clean CSV format
print(extracted_data.to_csv(index=False))
